...
const golferNameNorm = (n) => (n||"").trim().toLowerCase().replace(/\s+/g," ")
  .replace("speith","spieth").replace("henrick","henrik").replace("sung jae","sungjae")
  .replace("cam smith","cameron smith").replace("cam young","cameron young")
  .replace("matt fitzpatrick","matthew fitzpatrick").replace("rafa cabrera","rafael cabrera")
  .replace("tyrell","tyrrell");
const matchGolfer = (list, name) => {
  const n = golferNameNorm(name);
  return list.find(a => golferNameNorm(a.g) === n)
    || list.find(a => n.includes(golferNameNorm(a.g).split(" ").pop()) && golferNameNorm(a.g).split(" ").pop().length > 3 && golferNameNorm(a.g)[0] === n[0])
    || list.find(a => { const ag = golferNameNorm(a.g); return (n.startsWith(ag.substring(0,10)) || ag.startsWith(n.substring(0,10))); });
};

const AUCTION_DATA = {
  2017: [{g:"The Field",o:"Brian Black",p:165},{g:"Jordan Spieth",o:"Joe Mangione",p:152},{g:"Dustin Johnson",o:"Peter Berger",p:135},{g:"Rory McIlroy",o:"Pat Fitzgerald",p:91},{g:"Jason Day",o:"Steve Licata",p:75},{g:"Rickie Fowler",o:"Nick Mangione",p:46},{g:"Hideki Matsuyama",o:"Steve Licata",p:45},{g:"Phil Mickelson",o:"Michael Myers",p:42},{g:"Jon Rahm",o:"Pat Fitzgerald",p:40},{g:"Justin Rose",o:"Adam Yeager",p:37},{g:"Sergio Garcia",o:"Joe Mangione",p:36},{g:"Henrik Stenson",o:"Brian Black",p:35},{g:"Justin Thomas",o:"Alex Carroll",p:35},{g:"Adam Scott",o:"Steve Licata",p:33},{g:"Bubba Watson",o:"Brian Nickel",p:28},{g:"Louis Oosthuizen",o:"Bobby Reagan",p:27},{g:"Matt Kuchar",o:"Bobby Reagan",p:19},{g:"Patrick Reed",o:"Brian Black",p:20},{g:"Paul Casey",o:"Brian Gibbons",p:21},{g:"Brooks Koepka",o:"Nick Mangione",p:18},{g:"Marc Leishman",o:"Bobby Reagan",p:17},{g:"Tyrrell Hatton",o:"Michael Myers",p:17},{g:"Matthew Fitzpatrick",o:"Michael Myers",p:17},{g:"Thomas Pieters",o:"Adam Yeager",p:17},{g:"Charl Schwartzel",o:"Brian Black",p:17},{g:"Daniel Berger",o:"Adam Yeager",p:16},{g:"Zach Johnson",o:"Steve Licata",p:16},{g:"Jimmy Walker",o:"Jimmy Tangires",p:15},{g:"Lee Westwood",o:"Peter Berger",p:12},{g:"Bill Haas",o:"Bobby Reagan",p:11},{g:"Tommy Fleetwood",o:"Bobby Reagan",p:9},{g:"Adam Hadwin",o:"Brian Gibbons",p:9},{g:"Branden Grace",o:"Bobby Reagan",p:9},{g:"Gary Woodland",o:"Adam Yeager",p:9},{g:"Shane Lowry",o:"Brian Nickel",p:8},{g:"J.B. Holmes",o:"Joe Mangione",p:8},{g:"Russell Henley",o:"Peter Berger",p:6},{g:"Danny Willett",o:"Joe Mangione",p:6},{g:"Kevin Kisner",o:"Brian Black",p:6},{g:"Martin Kaymer",o:"Steve Licata",p:5}],
  2018: [{g:"Tiger Woods",o:"Jimmy Tangires",p:208},{g:"The Field",o:"Michael Myers",p:200},{g:"Justin Thomas",o:"Steve Licata",p:183},{g:"Jordan Spieth",o:"Joe Mangione",p:169},{g:"Dustin Johnson",o:"Shane Griffith",p:140},{g:"Rory McIlroy",o:"Brian Black",p:135},{g:"Bubba Watson",o:"Nick Mangione",p:91},{g:"Justin Rose",o:"Brian Black",p:90},{g:"Paul Casey",o:"JP Fischer",p:81},{g:"Rickie Fowler",o:"Pat Fitzgerald",p:80},{g:"Phil Mickelson",o:"Steve Childres",p:72},{g:"Matt Kuchar",o:"Shane Griffith",p:72},{g:"Jason Day",o:"Bobby Reagan",p:70},{g:"Jon Rahm",o:"Brian Black",p:69},{g:"Henrik Stenson",o:"Nick Mangione",p:49},{g:"Hideki Matsuyama",o:"Brian Gibbons",p:50},{g:"Patrick Reed",o:"Steve Licata",p:48},{g:"Alex Noren",o:"Brian Black",p:47},{g:"Tommy Fleetwood",o:"Bobby Reagan",p:45},{g:"Sergio Garcia",o:"Michael Myers",p:35},{g:"Thomas Pieters",o:"Brian Black",p:30},{g:"Bryson DeChambeau",o:"Michael Toomer",p:30},{g:"Louis Oosthuizen",o:"Brian Nickel",p:27},{g:"Marc Leishman",o:"Jimmy Tangires",p:26},{g:"Adam Scott",o:"Steve Licata",p:25},{g:"Ian Poulter",o:"Ryan Lee",p:23},{g:"Tony Finau",o:"Michael Toomer",p:22},{g:"Charley Hoffman",o:"Anthony Meek",p:19},{g:"Brian Harman",o:"JP Fischer",p:16},{g:"Kevin Kisner",o:"Alex Carroll",p:16},{g:"Charl Schwartzel",o:"Joe Mangione",p:15},{g:"Daniel Berger",o:"Steve Childres",p:15},{g:"Tyrrell Hatton",o:"Peter Berger",p:14},{g:"Branden Grace",o:"Steve Licata",p:14},{g:"Patrick Cantlay",o:"Michael Myers",p:12},{g:"Rafael Cabrera Bello",o:"Brian Gibbons",p:12},{g:"Xander Schauffele",o:"Alex Carroll",p:11},{g:"Matthew Fitzpatrick",o:"Brian Gibbons",p:10},{g:"Kiradech Aphibarnrat",o:"JP Fischer",p:10},{g:"Kevin Chappell",o:"Bobby Reagan",p:8},{g:"Gary Woodland",o:"Alex Carroll",p:7},{g:"Zach Johnson",o:"Steve Licata",p:7},{g:"Cameron Smith",o:"Nick Mangione",p:5},{g:"Pat Perez",o:"JP Fischer",p:5},{g:"Ryan Moore",o:"Ryan Lee",p:4}],
  2019: [{g:"The Field",o:"Joe Mangione",p:95},{g:"Rory McIlroy",o:"Erik Cobuzzi",p:90},{g:"Justin Rose",o:"Brian Black",p:88},{g:"Dustin Johnson",o:"Steve Childres",p:85},{g:"Justin Thomas",o:"Michael Myers",p:82},{g:"Brooks Koepka",o:"Ryan Lee",p:77},{g:"Tiger Woods",o:"Taylor Smyth",p:76},{g:"Jordan Spieth",o:"Joe Mangione",p:71},{g:"Francesco Molinari",o:"Steve Licata",p:70},{g:"Rickie Fowler",o:"Brian Gibbons",p:69},{g:"Jon Rahm",o:"Michael Myers",p:45},{g:"Tommy Fleetwood",o:"Bobby Reagan",p:41},{g:"Matt Kuchar",o:"Erik Cobuzzi",p:40},{g:"Jason Day",o:"Brian Black",p:40},{g:"Paul Casey",o:"Pat Fitzgerald",p:40},{g:"Hideki Matsuyama",o:"Bobby Reagan",p:40},{g:"Tony Finau",o:"Steve Licata",p:38},{g:"Bryson DeChambeau",o:"Michael Myers",p:38},{g:"Louis Oosthuizen",o:"JP Fischer",p:35},{g:"Xander Schauffele",o:"Taylor Smyth",p:30},{g:"Adam Scott",o:"Brian Black",p:30},{g:"Phil Mickelson",o:"Brian Nickel",p:30},{g:"Bubba Watson",o:"Taylor Smyth",p:28},{g:"Kevin Kisner",o:"Michael Myers",p:21},{g:"Patrick Reed",o:"Joe Mangione",p:20},{g:"Marc Leishman",o:"Brian Gibbons",p:20},{g:"Sergio Garcia",o:"Brian Gibbons",p:18},{g:"Henrik Stenson",o:"Steve Licata",p:16},{g:"Brandt Snedeker",o:"Erik Cobuzzi",p:15},{g:"Gary Woodland",o:"Ryan Lee",p:14},{g:"Charley Hoffman",o:"Steve Licata",p:14},{g:"Cameron Smith",o:"Taylor Smyth",p:13},{g:"Patrick Cantlay",o:"Bobby Reagan",p:11},{g:"Si Woo Kim",o:"Ryan Lee",p:9},{g:"Webb Simpson",o:"Michael Myers",p:7},{g:"Ian Poulter",o:"Michael Myers",p:7},{g:"Matthew Fitzpatrick",o:"Taylor Smyth",p:7},{g:"Billy Horschel",o:"Steve Childres",p:5},{g:"Hao Tong Li",o:"Steve Licata",p:5},{g:"Keegan Bradley",o:"Ryan Lee",p:5},{g:"Branden Grace",o:"JP Fischer",p:5},{g:"Rafa Cabrera Bello",o:"Taylor Smyth",p:4},{g:"Charles Howell III",o:"Brian Gibbons",p:4},{g:"Shane Lowry",o:"Michael Myers",p:3}],
  2021: [{g:"Dustin Johnson",o:"Brian Black",p:155},{g:"Jordan Spieth",o:"Joe Mangione",p:145},{g:"Justin Thomas",o:"Michael Myers",p:140},{g:"Bryson DeChambeau",o:"Michael Myers",p:138},{g:"Jon Rahm",o:"Joe Curran",p:105},{g:"The Field",o:"Brian Black",p:95},{g:"Rory McIlroy",o:"Taylor Smyth",p:80},{g:"Patrick Cantlay",o:"Brandon Call",p:80},{g:"Xander Schauffele",o:"Steve Licata",p:80},{g:"Collin Morikawa",o:"Taylor Smyth",p:80},{g:"Brooks Koepka",o:"Ryan Lee",p:61},{g:"Patrick Reed",o:"Brandon Call",p:60},{g:"Tony Finau",o:"Steve Licata",p:52},{g:"Cameron Smith",o:"Joe Curran",p:40},{g:"Paul Casey",o:"Brandon Call",p:38},{g:"Viktor Hovland",o:"Peter Berger",p:37},{g:"Sungjae Im",o:"Steve Licata",p:36},{g:"Lee Westwood",o:"Anthony Meek",p:35},{g:"Daniel Berger",o:"Brian Black",p:31},{g:"Scottie Scheffler",o:"Taylor Smyth",p:30},{g:"Matthew Fitzpatrick",o:"Brian Black",p:30},{g:"Hideki Matsuyama",o:"Peter Berger",p:29},{g:"Webb Simpson",o:"Brandon Call",p:29},{g:"Sergio Garcia",o:"Michael Myers",p:26},{g:"Joaquin Niemann",o:"Brandon Call",p:26},{g:"Tommy Fleetwood",o:"Brandon Call",p:25},{g:"Adam Scott",o:"Taylor Smyth",p:21},{g:"Abraham Ancer",o:"Steve Licata",p:21},{g:"Jason Day",o:"Michael Myers",p:20},{g:"Will Zalatoris",o:"Taylor Smyth",p:20},{g:"Tyrrell Hatton",o:"Peter Berger",p:20},{g:"Corey Conners",o:"Peter Berger",p:18},{g:"Bubba Watson",o:"Brian Gibbons",p:17},{g:"Louis Oosthuizen",o:"Brandon Call",p:15},{g:"Billy Horschel",o:"Joe Curran",p:12},{g:"Max Homa",o:"Steve Licata",p:12},{g:"Justin Rose",o:"Brian Gibbons",p:9},{g:"Shane Lowry",o:"Ryan Lee",p:9},{g:"Brian Harman",o:"Brandon Call",p:8},{g:"Harris English",o:"Ryan Lee",p:7},{g:"Jason Kokrak",o:"Brandon Call",p:6},{g:"Matthew Wolff",o:"Steve Licata",p:5},{g:"Victor Perez",o:"Peter Berger",p:5},{g:"Matt Wallace",o:"Peter Berger",p:4}],
  2022: [{g:"Justin Thomas",o:"Joe Mangione",p:107},{g:"Scottie Scheffler",o:"Steve Licata",p:101},{g:"Jon Rahm",o:"Michael Myers",p:98},{g:"Dustin Johnson",o:"Joe Curran",p:97},{g:"Cameron Smith",o:"Brian Gibbons",p:83},{g:"The Field",o:"Peter Berger",p:75},{g:"Brooks Koepka",o:"Ryan Lee",p:72},{g:"Jordan Spieth",o:"Joe Mangione",p:69},{g:"Xander Schauffele",o:"Brandon Call",p:65},{g:"Rory McIlroy",o:"Joe Mangione",p:55},{g:"Collin Morikawa",o:"Michael Myers",p:53},{g:"Patrick Cantlay",o:"Taylor Smyth",p:50},{g:"Viktor Hovland",o:"Joe Curran",p:45},{g:"Will Zalatoris",o:"Joe Mangione",p:35},{g:"Tony Finau",o:"Joe Curran",p:30},{g:"Tiger Woods",o:"Joe Mangione",p:26},{g:"Hideki Matsuyama",o:"Brian Gibbons",p:25},{g:"Sam Burns",o:"Michael Myers",p:25},{g:"Daniel Berger",o:"Brian Gibbons",p:24},{g:"Matthew Fitzpatrick",o:"Michael Myers",p:21},{g:"Justin Rose",o:"Scott Block",p:20},{g:"Louis Oosthuizen",o:"Taylor Smyth",p:20},{g:"Bryson DeChambeau",o:"Steve Licata",p:19},{g:"Corey Conners",o:"Taylor Smyth",p:18},{g:"Sungjae Im",o:"Ryan Lee",p:17},{g:"Shane Lowry",o:"Steve Licata",p:16},{g:"Patrick Reed",o:"Scott Block",p:16},{g:"Billy Horschel",o:"Joe Curran",p:16},{g:"Russell Henley",o:"Steve Licata",p:15},{g:"Adam Scott",o:"Brian Gibbons",p:15},{g:"Sergio Garcia",o:"Brian Gibbons",p:15},{g:"Tommy Fleetwood",o:"Steve Licata",p:12},{g:"Tyrrell Hatton",o:"Joe Curran",p:12},{g:"Paul Casey",o:"Brian Black",p:12},{g:"Marc Leishman",o:"Brian Black",p:12},{g:"Abraham Ancer",o:"Taylor Smyth",p:13},{g:"Max Homa",o:"Michael Butta",p:11},{g:"Bubba Watson",o:"Joe Curran",p:13},{g:"Si Woo Kim",o:"Joe Curran",p:8},{g:"Gary Woodland",o:"Taylor Smyth",p:6},{g:"Thomas Pieters",o:"Michael Myers",p:5}],
                  ...
                  <div style={{ background: cardBg, borderRadius: 8, padding: 14, border: `1px solid ${borderColor}` }}>
                    ...
                    <div style={{ marginTop: 8, borderTop: `1px solid ${borderColor}`, paddingTop: 6 }}>
                      {gh.data.map(d => {
                        ...
                        const entry = auction ? matchGolfer(auction, gh.golfer) : null;
                        return (
